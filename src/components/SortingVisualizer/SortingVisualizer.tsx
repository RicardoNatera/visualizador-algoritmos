...
const SortingVisualizer: React.FC = () => {
    ...
    const [speed, setSpeed] = useState(50); // menor = más rápido
  ...
  useEffect(() => {
    ...
    }, speed); // Velocidad de animación (ms)
  ...
  <button
  onClick={() => {
    setIsSorting(false); // detener la animación actual
    setSteps([]);        // limpiar pasos
    setStepIndex(0);     // reiniciar índice
    setActiveIndices([]);
    setSwapped(false);
    setArray(generateRandomArray(arraySize)); // nuevo array
  }}
